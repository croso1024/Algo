...
store_path3 = "/home/kangli/Ming_ws/GNN/Dataset/500000Square/"
...
#### Loading map ####
Benchmarker.setting("DatasetGenerate/trainMap_square.json")
...
def main(sampleSize = 20 ,dataSize =2 , save=True ,savePath =store_path3 ): 
    ...
    # print(Input)
    # print(tensor_Node_feature) 
    # print(tensor_Edge_index) 
    # print(tensor_Edge_weight)
    # print(tensor_y_CE)
    # print(tensor_opt) 
